...
import HomeWork8.Calculator.Components.DigitJButton;
import HomeWork8.Calculator.Components.OperatorJButton;
import HomeWork8.Calculator.Listeners.ButtonListener;
import HomeWork8.Calculator.Listeners.ClearFieldButtonListener;
...
public class ApplicationForm extends JFrame {
    ...
    private JPanel createTopPanel() {
        ...
        inputField.setFont(new Font("Courier New", Font.PLAIN, 25));
        inputField.setMargin(new Insets(8, 0, 8, 0));
        inputField.setBackground(new Color(158, 217, 255));
